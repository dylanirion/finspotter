...
export class MediaProcessingPipeline extends $util.ComponentResource {
  ...
  //TODO: watch for AppSync Events API Rule Target integration
  ...
  constructor(
    ...
    //TODO: write extension lambdas to database instead of as props
    ...
    function createIdentityPool(eventsApi: aws.appsync.Api) {
