...
export const EditPanelButtons = {
  ...
  Save: SaveButton<"bbox_xywha">,
  Delete: DeleteButton<"bbox_xywha">,
  Convert: ConvertButton<"bbox_xywha">,
}
...
function EditBoxButton() {
  const { stateMachine } = useAnnotation<"bbox_xywha">()
