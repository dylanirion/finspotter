...
from yolact_cpu.layers.box_utils import decode, jaccard
import numpy as np
import pyximport

pyximport.install(setup_args={"include_dirs": np.get_include()}, reload_support=True)
from yolact_cpu.utils.cython_nms import nms as cnms
...
class Detect(object):
    ...
    def fast_nms(
        ...
        # Only keep the top 100 highest scores across all classes
